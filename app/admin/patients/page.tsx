...
export default function AdminPatientsPage() {
  ...
  function openAdd() {
    ...
    setAddress(EMPTY_ADDRESS); setSelectedHelper(null); setHelperSearch('')
  ...
  function selectHelper(h: Helper) {
    setSelectedHelper(h); setHelperSearch(h.name)
    setForm(f => ({ ...f, helperId: h._id })); setShowHelperDrop(false)
  }
  ...
  const displayPatients = filterHelper ? patients.filter(p => (p.helperId as any)?._id === filterHelper) : patients
              ...
              {displayPatients.length === 0 ? (
                ...
                <tr key={p._id}>
                  ...
                  <td>
                    ...
                    <span className="badge badge-green" style={{ fontSize: 10 }}>{(p.helperId as any)?.tag}</span>
                  </td>
              ...
              <div className="modal-body">
                ...
                <div className="form-group" ref={dropRef} style={{ position: 'relative' }}>
                  ...
                  <input className="form-input" placeholder="🔍 Search by name, phone, block, GP, ID..."
                    ...
                    onChange={e => { setHelperSearch(e.target.value); setSelectedHelper(null); setForm(f => ({ ...f, helperId: '' })); setShowHelperDrop(true) }} />
                  {!selectedHelper && <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 4 }}>💡 Search by name, phone, block, GP or coordinator ID</div>}
