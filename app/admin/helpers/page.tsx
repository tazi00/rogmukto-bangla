...
import CascadeLocationSelect, {
  EMPTY_VAL,
  LocationValue,
} from "@/components/CascadeLocationSelect";
...
export default function HelpersPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (
      ...
      !location.blockId ||
      !location.gramPanchayatId
    ) {
      setError("Please select Sub Division, Block, and Gram Panchayat");
      return;
    }
    setLoading(true);
    setError("");
