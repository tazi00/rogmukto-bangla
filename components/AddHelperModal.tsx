...
export default function AddHelperModal({ onClose, onSave }: Props) {
  ...
  const [form, setForm] = useState({ name: '', phone: '', tag: 'Swasthya Bondhu' })
          ...
          <div className="modal-body">
            ...
            <div className="form-group" ref={dropRef} style={{ position: 'relative' }}>
              ...
              {showBCDrop && !selectedBC && (
                <div style={{ position: 'absolute', top: '100%', left: 0, right: 0, zIndex: 300, border: '1px solid var(--border)', borderRadius: 'var(--radius-sm)', background: 'var(--surface)', boxShadow: 'var(--shadow-md)', maxHeight: 180, overflowY: 'auto' }}>
